...
FINAL_IMAGE=dist/${CND_CONF}/${IMAGE_TYPE}/Laboratory7.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
else
...
SOURCEFILES_QUOTED_IF_SPACED=display.c main.c "uart interface.c"

# Object Files Quoted if spaced
OBJECTFILES_QUOTED_IF_SPACED=${OBJECTDIR}/display.o ${OBJECTDIR}/main.o "${OBJECTDIR}/uart interface.o"
POSSIBLE_DEPFILES=${OBJECTDIR}/display.o.d ${OBJECTDIR}/main.o.d "${OBJECTDIR}/uart interface.o.d"

# Object Files
OBJECTFILES=${OBJECTDIR}/display.o ${OBJECTDIR}/main.o ${OBJECTDIR}/uart\ interface.o

# Source Files
SOURCEFILES=display.c main.c uart interface.c
...
ifneq ($(INFORMATION_MESSAGE), )
	...
	${MAKE}  -f nbproject/Makefile-default.mk dist/${CND_CONF}/${IMAGE_TYPE}/Laboratory7.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
...
${OBJECTDIR}/uart\ interface.o: uart\ interface.c  nbproject/Makefile-${CND_CONF}.mk
	@${MKDIR} "${OBJECTDIR}" 
	@${RM} "${OBJECTDIR}/uart interface.o".d 
	@${RM} "${OBJECTDIR}/uart interface.o" 
	@${FIXDEPS} "${OBJECTDIR}/uart interface.o.d" $(SILENT) -rsi ${MP_CC_DIR}../  -c ${MP_CC}  $(MP_EXTRA_CC_PRE) -g -D__DEBUG -D__MPLAB_DEBUGGER_PK3=1  -fframe-base-loclist  -x c -c -mprocessor=$(MP_PROCESSOR_OPTION)  -MMD -MF "${OBJECTDIR}/uart interface.o.d" -o "${OBJECTDIR}/uart interface.o" "uart interface.c"    -DXPRJ_default=$(CND_CONF)  -legacy-libc  $(COMPARISON_BUILD) 
...
${OBJECTDIR}/uart\ interface.o: uart\ interface.c  nbproject/Makefile-${CND_CONF}.mk
	...
	@${RM} "${OBJECTDIR}/uart interface.o".d 
	@${RM} "${OBJECTDIR}/uart interface.o" 
	@${FIXDEPS} "${OBJECTDIR}/uart interface.o.d" $(SILENT) -rsi ${MP_CC_DIR}../  -c ${MP_CC}  $(MP_EXTRA_CC_PRE)  -g -x c -c -mprocessor=$(MP_PROCESSOR_OPTION)  -MMD -MF "${OBJECTDIR}/uart interface.o.d" -o "${OBJECTDIR}/uart interface.o" "uart interface.c"    -DXPRJ_default=$(CND_CONF)  -legacy-libc  $(COMPARISON_BUILD) 
...
dist/${CND_CONF}/${IMAGE_TYPE}/Laboratory7.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk   
	...
	${MP_CC_DIR}\\xc32-bin2hex dist/${CND_CONF}/${IMAGE_TYPE}/Laboratory7.X.${IMAGE_TYPE}.${DEBUGGABLE_SUFFIX} 
endif
